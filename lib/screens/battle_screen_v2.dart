...
class BattleScreenV2 extends StatefulWidget {
  ...
  @override
  State<BattleScreenV2> createState() => _BattleScreenV2State();
}

class _BattleScreenV2State extends State<BattleScreenV2>
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildExecuteTurnButton(),
        ],
      ),
    );
  }

  Widget _buildSelectedCharacterHeader() {
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                color: _getRarityColor(selectedCharacter!.character.rarity),
                width: 2,
              ),
            ),
            child: ClipRRect(
  ...
  Widget _buildSpecialAbilityCard() {
    ...
    int? cooldown = selectedCharacter!
          ...
          children: [
            ...
            Row(
              children: [
                ...
                if (selectedCharacter!.character.specialAbilityCooldown >
                    0) ...[
  ...
  Widget _buildExecuteTurnButton() {
    return SizedBox(
      width: double.infinity,
